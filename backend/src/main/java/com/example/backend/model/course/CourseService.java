...
public class CourseService {
    ...
    private CourseDTO mapToDTO(Course course) {
        ...
        return CourseDTO.builder()
                ...
                .coordinatorName(course.getCoordinator() != null ? course.getCoordinator().getName() + " " + course.getCoordinator().getSurname() : null)
                .coordinatorEmail(course.getCoordinator() != null ? course.getCoordinator().getEmail() : null)
                .build();
    }
