...
import { fetchInbox, markAsRead, fetchUnreadCount } from "../../../services/messageApi";
...
function InboxPage() {
    ...
    if (loading) return <div className="loading-state">Ładowanie wiadomości...</div>;
                            ...
                            <div className="inbox-detail">
                                <div className="inbox-detail-header">
                                    ...
                                    <p className="inbox-detail-meta">
                                        Od: {selectedMsg.senderName} | {formatDate(selectedMsg.sentAt)}
                                    </p>
                                </div>
