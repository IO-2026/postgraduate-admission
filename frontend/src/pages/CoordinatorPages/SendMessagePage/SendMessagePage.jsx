...
function SendMessagePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!toAll && selectedIds.length === 0) {
            setError("Wybierz co najmniej jednego odbiorcę lub zaznacz 'Wszyscy kandydaci'.");
            return;
        }
    ...
    if (loading) return <div className="loading-state">Ładowanie listy kandydatów...</div>;
        ...
        <section className="send-message-view">
            <div className="send-message-top-actions">
                <Link className="ghost-link send-message-back-link" to="/">
                    <svg className="send-message-back-icon" viewBox="0 0 24 24" fill="none">
                    ...
                    {!toAll && (
                        <div className="recipients-list">
                            <div className="recipients-header">
                                ...
                                <button type="button" className="ghost-btn-small" onClick={toggleSelectAll}>
                                    {selectedIds.length === recipients.length ? "Odznacz wszystkich" : "Zaznacz wszystkich"}
                                </button>
                            </div>
