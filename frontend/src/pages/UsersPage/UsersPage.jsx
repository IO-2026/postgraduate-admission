...
function UsersPage() {
  ...
  if (loading) {
    return <div className="users-page"><p>Ładowanie...</p></div>;
  }
  ...
  return (
    <div className="users-page">
      <header className="users-header">
        ...
        <p className="users-subtitle">Zmieniaj uprawnienia użytkowników w systemie.</p>
      </header>
      ...
      <div className="table-container">
        <table className="users-table">
          ...
          <tbody>
            ...
            {users.length === 0 && (
              <tr>
                <td colSpan="5" className="empty-table">Brak użytkowników</td>
              </tr>
            )}
          </tbody>
        </table>
